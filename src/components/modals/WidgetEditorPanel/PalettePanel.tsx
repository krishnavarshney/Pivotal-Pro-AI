...
const SelectableFieldRow: React.FC<{ field: Field }> = ({ field }) => {
    ...
    return (
        <div ref={drag as any} className={cn(
            "flex items-center gap-2 bg-secondary/50 border border-transparent rounded-lg p-2 transition-colors cursor-grab",
...
const DataTab: React.FC = () => {
    const { blendedFields, aiConfig, populateEditorFromAI, widgetEditorAIPrompt, setWidgetEditorAIPrompt, blendedData } = useDashboard();
