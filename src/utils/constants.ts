import { Template, FieldType, ChartType, AggregationType, WidgetDisplayMode } from './types';
...
export const THEME_DEFINITIONS = [
    { id: 'pivotal-pro', name: 'Pivotal Pro' },
    ...
    { id: 'geist-minimal', name: 'Geist Minimal' },
...
export const DASHBOARD_TEMPLATES: Template[] = [
    ...
    },
    {
        ...
        page: {
            name: 'Weekly Sales Review',
            widgets: [
                { id: 'sr_w1', title: 'Total Sales', chartType: ChartType.KPI, displayMode: 'chart', shelves: { columns: [], rows: [], filters: [], values: [{id:'sr_p1', name:'{{sales}}', aggregation: AggregationType.SUM, type: FieldType.MEASURE, simpleName:'Sales'}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'sr_w2', title: 'Total Profit', chartType: ChartType.KPI, displayMode: 'chart', shelves: { columns: [], rows: [], filters: [], values: [{id:'sr_p2', name:'{{profit}}', aggregation: AggregationType.SUM, type: FieldType.MEASURE, simpleName:'Profit'}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'sr_w3', title: 'Sales Trend', chartType: ChartType.AREA, displayMode: 'chart', shelves: { columns: [], rows: [{id:'sr_p3', name:'{{date}}', type: FieldType.DATETIME, simpleName:'Date', aggregation: AggregationType.COUNT}], filters: [], values: [{id:'sr_p4', name:'{{sales}}', aggregation: AggregationType.SUM, type: FieldType.MEASURE, simpleName:'Sales'}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'sr_w4', title: 'Sales by Region', chartType: ChartType.BAR, displayMode: 'chart', shelves: { columns: [], rows: [{id:'sr_p5', name:'{{region}}', type: FieldType.DIMENSION, simpleName:'Region', aggregation: AggregationType.COUNT}], filters: [], values: [{id:'sr_p6', name:'{{sales}}', aggregation: AggregationType.SUM, type: FieldType.MEASURE, simpleName:'Sales'}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'sr_w5', title: 'Profit by Category', chartType: ChartType.BAR, displayMode: 'chart', shelves: { columns: [], rows: [{id:'sr_p7', name:'{{category}}', type: FieldType.DIMENSION, simpleName:'Category', aggregation: AggregationType.COUNT}], filters: [], values: [{id:'sr_p8', name:'{{profit}}', aggregation: AggregationType.SUM, type: FieldType.MEASURE, simpleName:'Profit'}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'sr_w6', title: 'Top 10 Customers by Sales', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{id:'sr_p9', name:'{{customer_name}}', type: FieldType.DIMENSION, simpleName:'Customer Name', aggregation: AggregationType.COUNT}], filters: [], values: [{id:'sr_p10', name:'{{sales}}', aggregation: AggregationType.SUM, type: FieldType.MEASURE, simpleName:'Sales'}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'sr_w7', title: 'Product Performance', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{id:'sr_p11', name:'{{product_name}}', type: FieldType.DIMENSION, simpleName:'Product Name', aggregation: AggregationType.COUNT}], filters: [], values: [{id:'sr_p12', name:'{{sales}}', aggregation: AggregationType.SUM, type: FieldType.MEASURE, simpleName:'Sales'}, {id:'sr_p13', name:'{{profit}}', aggregation: AggregationType.SUM, type: FieldType.MEASURE, simpleName:'Profit'}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
            ],
            layouts: {
                lg: [
    ...
    },
    {
        ...
        page: {
            ...
            widgets: [
                { id: 'mp_w1', title: 'Total Spend', chartType: ChartType.KPI, displayMode: 'chart', shelves: { columns: [], rows: [], filters: [], values: [{id:'mp_p1', name:'{{cost}}', simpleName:'Cost', type:FieldType.MEASURE, aggregation:AggregationType.SUM}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'mp_w2', title: 'Total Revenue', chartType: ChartType.KPI, displayMode: 'chart', shelves: { columns: [], rows: [], filters: [], values: [{id:'mp_p2', name:'{{revenue}}', simpleName:'Revenue', type:FieldType.MEASURE, aggregation:AggregationType.SUM}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'mp_w3', title: 'Revenue vs Cost by Campaign', chartType: ChartType.BAR, displayMode: 'chart', shelves: { columns: [], rows: [{id:'mp_p3', name:'{{campaign}}', simpleName:'Campaign', type:FieldType.DIMENSION, aggregation:AggregationType.COUNT}], filters: [], values: [{id:'mp_p4', name:'{{revenue}}', simpleName:'Revenue', type:FieldType.MEASURE, aggregation:AggregationType.SUM}, {id:'mp_p5', name:'{{cost}}', simpleName:'Cost', type:FieldType.MEASURE, aggregation:AggregationType.SUM}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'mp_w4', title: 'Conversions Over Time', chartType: ChartType.LINE, displayMode: 'chart', shelves: { columns: [], rows: [{id:'mp_p6', name:'{{date}}', simpleName:'Date', type:FieldType.DATETIME, aggregation:AggregationType.COUNT}], filters: [], values: [{id:'mp_p7', name:'{{conversions}}', simpleName:'Conversions', type:FieldType.MEASURE, aggregation:AggregationType.SUM}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'mp_w5', title: 'Impressions vs. Clicks', chartType: ChartType.SCATTER, displayMode: 'chart', shelves: { columns: [{id:'mp_p8', name:'{{impressions}}', simpleName:'Impressions', type:FieldType.MEASURE, aggregation:AggregationType.SUM}], rows: [{id:'mp_p9', name:'{{clicks}}', simpleName:'Clicks', type:FieldType.MEASURE, aggregation:AggregationType.SUM}], filters: [], values: [], category: [{id:'mp_p10', name:'{{campaign}}', simpleName:'Campaign', type:FieldType.DIMENSION, aggregation:AggregationType.COUNT}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'mp_w6', title: 'Campaign Performance', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{id:'mp_p11', name:'{{campaign}}', simpleName:'Campaign', type:FieldType.DIMENSION, aggregation:AggregationType.COUNT}], filters: [], values: [{id:'mp_p12', name:'{{impressions}}', simpleName:'Impressions', type:FieldType.MEASURE, aggregation:AggregationType.SUM}, {id:'mp_p13', name:'{{clicks}}', simpleName:'Clicks', type:FieldType.MEASURE, aggregation:AggregationType.SUM}, {id:'mp_p14', name:'{{conversions}}', simpleName:'Conversions', type:FieldType.MEASURE, aggregation:AggregationType.SUM}, {id:'mp_p15', name:'{{cost}}', simpleName:'Cost', type:FieldType.MEASURE, aggregation:AggregationType.SUM}, {id:'mp_p16', name:'{{revenue}}', simpleName:'Revenue', type:FieldType.MEASURE, aggregation:AggregationType.SUM}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'mp_w7', title: 'Daily Performance', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{id:'mp_p17', name:'{{date}}', simpleName:'Date', type:FieldType.DATETIME, aggregation:AggregationType.COUNT}], filters: [], values: [{id:'mp_p18', name:'{{impressions}}', simpleName:'Impressions', type:FieldType.MEASURE, aggregation:AggregationType.SUM}, {id:'mp_p19', name:'{{clicks}}', simpleName:'Clicks', type:FieldType.MEASURE, aggregation:AggregationType.SUM}, {id:'mp_p20', name:'{{cost}}', simpleName:'Cost', type:FieldType.MEASURE, aggregation:AggregationType.SUM}] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
            ],
            layouts: {
                lg: [
    ...
    },
    {
        ...
        page: {
            name: 'Financial Health',
             widgets: [
                { id: 'fh_w1', title: 'Financial Summary', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{id:'fh_p1', name:'{{account}}', simpleName:'Account', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT}], filters: [], values: [{id:'fh_p2', name:'{{amount}}', simpleName:'Amount', type: FieldType.MEASURE, aggregation: AggregationType.SUM}]} , subtotalSettings: { rows: false, columns: false, grandTotal: true }},
                { id: 'fh_w2', title: 'Financials Over Time', chartType: ChartType.BAR, displayMode: 'chart', shelves: { columns: [{id:'fh_p4', name:'{{account}}', simpleName:'Account', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT}], rows: [{id:'fh_p3', name:'{{date}}', simpleName:'Date', type: FieldType.DATETIME, aggregation: AggregationType.COUNT}], filters: [], values: [{id:'fh_p5', name:'{{amount}}', simpleName:'Amount', type: FieldType.MEASURE, aggregation: AggregationType.SUM}]} , subtotalSettings: { rows: false, columns: false, grandTotal: true }},
            ],
            layouts: {
                lg: [
    ...
    },
    {
        ...
        page: {
            name: 'Operations KPI Dashboard',
            widgets: [
                { id: 'ok_w1', title: 'Total Tickets', chartType: ChartType.KPI, displayMode: 'chart', shelves: { columns: [], rows: [], filters: [], values: [{ id: 'ok_p1', name: '{{ticket_id}}', simpleName: 'Ticket ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'ok_w2', title: 'Average CSAT', chartType: ChartType.KPI, displayMode: 'chart', shelves: { columns: [], rows: [], filters: [], values: [{ id: 'ok_p2', name: '{{csat_score}}', simpleName: 'CSAT Score', type: FieldType.MEASURE, aggregation: AggregationType.AVERAGE }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'ok_w3', title: 'Tickets Created Over Time', chartType: ChartType.LINE, displayMode: 'chart', shelves: { columns: [], rows: [{ id: 'ok_p3', name: '{{creation_date}}', simpleName: 'Creation Date', type: FieldType.DATETIME, aggregation: AggregationType.COUNT }], filters: [], values: [{ id: 'ok_p4', name: '{{ticket_id}}', simpleName: 'Ticket ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'ok_w4', title: 'Tickets by Priority', chartType: ChartType.PIE, displayMode: 'chart', shelves: { columns: [], rows: [{ id: 'ok_p5', name: '{{priority}}', simpleName: 'Priority', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }], filters: [], values: [{ id: 'ok_p6', name: '{{ticket_id}}', simpleName: 'Ticket ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'ok_w5', title: 'Tickets per Agent', chartType: ChartType.BAR, displayMode: 'chart', shelves: { columns: [], rows: [{ id: 'ok_p7', name: '{{agent_name}}', simpleName: 'Agent Name', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }], filters: [], values: [{ id: 'ok_p8', name: '{{ticket_id}}', simpleName: 'Ticket ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'ok_w6', title: 'Recent Tickets', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{ id: 'ok_p9', name: '{{creation_date}}', simpleName: 'Creation Date', type: FieldType.DATETIME, aggregation: AggregationType.COUNT }, { id: 'ok_p10', name: '{{agent_name}}', simpleName: 'Agent Name', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }, { id: 'ok_p11', name: '{{priority}}', simpleName: 'Priority', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }, { id: 'ok_p12', name: '{{status}}', simpleName: 'Status', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }], filters: [], values: [] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'ok_w7', title: 'Agent Performance', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{ id: 'ok_p13', name: '{{agent_name}}', simpleName: 'Agent Name', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }], filters: [], values: [{ id: 'ok_p14', name: '{{ticket_id}}', simpleName: 'Ticket ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }, { id: 'ok_p15', name: '{{csat_score}}', simpleName: 'CSAT Score', type: FieldType.MEASURE, aggregation: AggregationType.AVERAGE }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
            ],
            layouts: {
                lg: [
    ...
    },
    {
        ...
        page: {
            ...
            widgets: [
                { id: 'hr_w1', title: 'Total Headcount', chartType: ChartType.KPI, displayMode: 'chart', shelves: { columns: [], rows: [], filters: [], values: [{ id: 'hr_p1', name: '{{employee_id}}', simpleName: 'Employee ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'hr_w2', title: 'Average Salary', chartType: ChartType.KPI, displayMode: 'chart', shelves: { columns: [], rows: [], filters: [], values: [{ id: 'hr_p2', name: '{{salary}}', simpleName: 'Salary', type: FieldType.MEASURE, aggregation: AggregationType.AVERAGE }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'hr_w3', title: 'Headcount by Department', chartType: ChartType.BAR, displayMode: 'chart', shelves: { columns: [], rows: [{ id: 'hr_p3', name: '{{department}}', simpleName: 'Department', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }], filters: [], values: [{ id: 'hr_p4', name: '{{employee_id}}', simpleName: 'Employee ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'hr_w4', title: 'Gender Diversity', chartType: ChartType.PIE, displayMode: 'chart', shelves: { columns: [], rows: [{ id: 'hr_p5', name: '{{gender}}', simpleName: 'Gender', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }], filters: [], values: [{ id: 'hr_p6', name: '{{employee_id}}', simpleName: 'Employee ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'hr_w5', title: 'Hires Over Time', chartType: ChartType.LINE, displayMode: 'chart', shelves: { columns: [], rows: [{ id: 'hr_p7', name: '{{start_date}}', simpleName: 'Start Date', type: FieldType.DATETIME, aggregation: AggregationType.COUNT }], filters: [], values: [{ id: 'hr_p8', name: '{{employee_id}}', simpleName: 'Employee ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'hr_w6', title: 'Employee List', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{ id: 'hr_p9', name: '{{employee_id}}', simpleName: 'Employee ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }, { id: 'hr_p10', name: '{{department}}', simpleName: 'Department', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }, { id: 'hr_p11', name: '{{start_date}}', simpleName: 'Start Date', type: FieldType.DATETIME, aggregation: AggregationType.COUNT }], filters: [], values: [] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
                { id: 'hr_w7', title: 'Department Salary Overview', chartType: ChartType.TABLE, displayMode: 'table', shelves: { columns: [], rows: [{ id: 'hr_p12', name: '{{department}}', simpleName: 'Department', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }], filters: [], values: [{ id: 'hr_p13', name: '{{employee_id}}', simpleName: 'Employee ID', type: FieldType.DIMENSION, aggregation: AggregationType.COUNT }, { id: 'hr_p14', name: '{{salary}}', simpleName: 'Salary', type: FieldType.MEASURE, aggregation: AggregationType.AVERAGE }] }, subtotalSettings: { rows: false, columns: false, grandTotal: true } },
            ],
            layouts: {
                lg: [
